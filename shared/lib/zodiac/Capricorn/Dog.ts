...
export const Capricorn_Dog_male: ZodiacNarrative = {
  ...
  fullNarrative: `
You are integrity in motion — dependable, loyal, emotionally composed, and quietly intense. You don't seek validation — you seek *alignment*. And when it comes to love, you're not here to play games. You're here to *build* something unshakeable.

In love, you are slow to trust, but deeply faithful once your heart is committed. You crave a partner who leads with honesty, meets you in effort, and understands that your silence doesn't mean absence — it means *depth in translation*. You don't offer surface-level affection. You offer *fortress-level* loyalty.
...
In your work, you're consistent, focused, and mission-driven. You value responsibility — not for its image, but for its impact. You take pride in what you protect and what you produce. You don't cut corners, and you don't tolerate betrayal — in business or in love.

In family and friendship, you're the anchor — stable, principled, and fiercely dependable. You don't give loyalty lightly, but once given, it's unwavering. You show up when it matters most — especially when no one else does.
...
- Protecting those you love — without needing praise for it.
...
- Realizing that connection is created — not just protected.
...
export const Capricorn_Dog_female: ZodiacNarrative = {
  summary: "A dignified protector — loyal, composed, emotionally intuitive, and fiercely devoted to a love that feels both safe and sacred.",
  ...
  fullNarrative: `
You are loyalty with layers — steady, intuitive, emotionally wise, and unwavering in your devotion. You don't give your heart away easily, but when you do, it's with full presence and fierce protection. You don't *need* to be needed — but when you're chosen, you stand *unshakably* by your choice.

In love, you are grounded and nurturing, yet exacting. You expect clarity, honesty, and commitment — not perfection, but *principle*. You want a partner who values depth over performance, and who sees your strength not as a challenge, but as an *invitation* to rise beside you.

You love through loyalty. Through quiet acts of care, thoughtful presence, and unspoken emotional intuition. You don't show affection for show — you show it for *keeps*. But if that loyalty is betrayed, disrespected, or manipulated? You don't scream. You *shut the door* — cleanly, silently, with zero need for revenge.
...
With family and friends, you're fiercely protective and nurturing. You love hard, hold firm, and expect emotional honesty in return. You'd rather be alone than tolerated — and those in your circle know they are *chosen*, not just accepted.
...
- Leading through consistency — not control.
