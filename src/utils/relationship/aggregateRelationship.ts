// src/utils/relationship/aggregateRelationship.ts

export const getRelationshipReadinessResultFromAnswers = (answers: string[]): string => {
  // Define Relationship Readiness Traits
  ...
  answers.forEach((answer, index) => {
    const styles = relationshipMap[index + 1]; // Adjust if your mapping logic needs to start from 1
