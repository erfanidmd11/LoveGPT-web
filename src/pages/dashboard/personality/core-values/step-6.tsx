...
export default function CoreValueStep6() {
  ...
  const handleFinish = () => {
    localStorage.setItem('core-values-step-6', JSON.stringify(selected));
    router.push('/dashboard/personality/core-values/summary');
  };

  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto px-6 py-16">
        <h1 className="text-2xl font-bold text-indigo-700 mb-6">Core Value Index – Final Step (6 of 6)</h1>
