...
export default function CoreValueStep4() {
  ...
  const handleNext = () => {
    localStorage.setItem('core-values-step-4', JSON.stringify(selected));
    router.push('/dashboard/personality/core-values/step-5');
  };

  return (
    <DashboardLayout>
      <div className="max-w-2xl mx-auto px-6 py-16">
        <h1 className="text-2xl font-bold text-indigo-700 mb-6">Core Value Index – Step 4 of 6</h1>
